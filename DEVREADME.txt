readme for the devs 
whenever updating anything that requires code structure understanding or constant understanding just write it down here so we all are on the same page
